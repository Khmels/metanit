...
public class P3_10_Interface {
    public static void main(String[] args) {
        ...
        P3_10_Interface_Printable printable = new Book("Java. Complete Reference", "H. Shildt");
        ...
        P3_10_Interface_Printable p =new Journal("Foreign Affairs");
        p.print();
        ...
        // --- Методы по умолчанию ---
        /*
        Ранее до JDK 8 при реализации интерфейса должны были обязательно реализовать все его методы в классе.
