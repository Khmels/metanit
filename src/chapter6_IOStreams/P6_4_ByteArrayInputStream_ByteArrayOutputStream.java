...
public class P6_4_ByteArrayInputStream_ByteArrayOutputStream {
...
*/
    ...
    public static void main(String[] args) {
        ...
        В данном случае записывается в поток массив байтов.
        ...
        /*
        С помощью метода writeTo можно вывести массив байт в другой поток.
